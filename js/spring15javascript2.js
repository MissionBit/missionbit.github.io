...
window.jQuery(function ($) {
    ...
    $("#spring15-javascript2-submit").on('click', function (e) {
			...
			if (!firstName || !lastName || !isEmail || school === "school" || grade === "grade" || gender === "gender" || ethnicity === "ethnicity") {
				...
				var Fall15Javascript2 = Parse.Object.extend("Fall15Javascript2");
				var fall15Javascript2 = new Fall15Javascript2();
				fall15Javascript2.set("firstName", firstName);
				fall15Javascript2.set("lastName", lastName);
				fall15Javascript2.set("email", email);
				fall15Javascript2.set("cell", cell);
				fall15Javascript2.set("school", school);
				fall15Javascript2.set("grade", grade);
				fall15Javascript2.set("gender", gender);
				fall15Javascript2.set("ethnicity", ethnicity);
